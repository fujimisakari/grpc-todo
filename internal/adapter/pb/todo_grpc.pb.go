...
const (
	...
	TodoService_UpdateTodotatus_FullMethodName = "/todo.TodoService/UpdateTodotatus"
...
type TodoServiceClient interface {
	...
	UpdateTodotatus(ctx context.Context, in *UpdateTodoStatusRequest, opts ...grpc.CallOption) (*TodoResponse, error)
...
func (c *todoServiceClient) UpdateTodotatus(ctx context.Context, in *UpdateTodoStatusRequest, opts ...grpc.CallOption) (*TodoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TodoResponse)
	err := c.cc.Invoke(ctx, TodoService_UpdateTodotatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TodoServiceServer interface {
	...
	UpdateTodotatus(context.Context, *UpdateTodoStatusRequest) (*TodoResponse, error)
...
func (UnimplementedTodoServiceServer) UpdateTodotatus(context.Context, *UpdateTodoStatusRequest) (*TodoResponse, error) {
...
func _TodoService_UpdateTodotatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTodoStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TodoServiceServer).UpdateTodotatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TodoService_UpdateTodotatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).UpdateTodotatus(ctx, req.(*UpdateTodoStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TodoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateTodotatus",
			Handler:    _TodoService_UpdateTodotatus_Handler,
		},
		{
